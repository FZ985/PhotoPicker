...
//
//    public LogConfigurator2() {
//    }
//
//    /**
//     * @param fileName Name of the log file
//     */
//    public LogConfigurator2(final String fileName) {
...
//     */
//    public LogConfigurator2(final String fileName, final Level rootLevel) {
//        this(fileName);
...
//     */
//    public LogConfigurator2(final String fileName, final Level rootLevel, final String filePattern) {
//        this(fileName);
//        setRootLevel(rootLevel);
...
//     * @param rootLevel     Log level for the root logger
//     */
//    public LogConfigurator2(final String fileName, final int maxBackupSize,
...
//        final Logger root = Logger.getRootLogger();
//        final RollingFileAppender2 rollingFileAppender;
//        final Layout fileLayout = new PatternLayout(getFilePattern());
//
//        try {
//            rollingFileAppender = new RollingFileAppender2(fileLayout, getFileName());
